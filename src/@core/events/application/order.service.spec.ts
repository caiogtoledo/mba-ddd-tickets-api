...
test.skip('deve criar uma order', async () => {
  ...
  const op1 = orderService.create({
    ...
    section_id: event.sections.getItems()[0].id.value,
    customer_id: customer.id.value,
    spot_id: event.sections.getItems()[0].spots.getItems()[0].id.value,
    card_token: 'tok_visa',
  });
